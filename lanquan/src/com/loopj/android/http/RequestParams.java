...
public class RequestParams implements Serializable {
	...
	private HttpEntity createJsonStreamerEntity(ResponseHandlerInterface progressHandler) throws IOException {
		...
		for (ConcurrentHashMap.Entry<String, String> entry : urlParams.entrySet()) {
			...
			md5String.append(entry.getValue());
		}
		...
		entity.addPart("sign", MD5For32.GetMD5Code(md5String.toString()));
		LogTool.i(md5String.toString());
		return entity;
	}
	...
	private HttpEntity createMultipartEntity(ResponseHandlerInterface progressHandler) throws IOException {
		...
		entity.addPartWithCharset("sign", MD5For32.GetMD5Code(md5String.toString()), contentEncoding);
		LogTool.i(md5String.toString());
		return entity;
	}
