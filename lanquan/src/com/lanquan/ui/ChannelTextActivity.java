...
/**
 * 类描述 ：文字频道详情页面 类名： ChannelTextActivity.java 
 * Copyright: Copyright (c)2015
 * Company: zhangshuai
 * 
 * @author: zhangshuai
 * @version: 1.0 创建时间: 2015-8-7 下午4:04:34
 */
public class ChannelTextActivity extends BaseActivity implements OnClickListener {
	...
	protected void initView() {
		...
		choicenessMenuPopupWindow = new ChoicenessMenuPopupWindow(ChannelTextActivity.this, jsonChannel.getTitle());
		...
		channelListView.setOnRefreshListener(new OnRefreshListener2<ListView>() {
			...
			public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
				// TODO Auto-generated method stub
				String label = DateUtils.formatDateTime(ChannelTextActivity.this.getApplicationContext(), System.currentTimeMillis(),
	...
	public void onClick(View v) {
		...
		case R.id.right_btn_bg2:
			startActivityForResult(new Intent(ChannelTextActivity.this, ChannelInfoActivity.class).putExtra(JSONCHANNEL, jsonChannel), 1);
	...
	private void getDataTask(int p) {
		...
		AsyncHttpClientTool.post(ChannelTextActivity.this, "api/article/articles", params, responseHandler);
	}
	...
	/**
	 * 类描述 ：频道列表适配器 类名： PhotoChannelDetailActivity.java Copyright: Copyright
	 * (c)2015 Company: zhangshuai
	 * 
	 * @author: zhangshuai
	 * @version: 1.0 创建时间: 2015-8-7 下午4:23:59
	 */
	class CommentAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = LayoutInflater.from(ChannelTextActivity.this).inflate(R.layout.channel_comment_list_item, null);
	...
	/**
	 * 类描述 ： 频道详情页面点击频道名称，显示的菜单，显示全部和只显示精选 类名： ChoicenessMenuPopupWindow.java
	 * Copyright: Copyright (c)2015 Company: zhangshuai
	 * 
	 * @author: zhangshuai
	 * @version: 1.0 创建时间: 2015-8-11 下午2:35:59
	 */
