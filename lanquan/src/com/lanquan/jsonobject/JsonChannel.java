...
public class JsonChannel implements Serializable {
	...
	public JsonChannel(int c_id, int c_userid, String c_username, String c_small_avatar, String c_large_avatar, String c_title, String c_big_photo,
			Date c_time, int c_favor_count) {
		super();
		this.c_id = c_id;
